            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  placeholder={isAdminLogin ? "admin@accurateexam.com" : "you@example.com"}
                  disabled={loading}
                />
              </div>
              ...
              <Button type="submit" className={`w-full ${isAdminLogin ? 'bg-destructive hover:bg-destructive/90' : ''}`} size="lg" disabled={loading}>
